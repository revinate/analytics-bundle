...
/**
 * appTest_localDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class appTest_localDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'revinate_analytics.elastica' => 'getRevinateAnalytics_ElasticaService',
            'revinate_analytics.routing_loader' => 'getRevinateAnalytics_RoutingLoaderService',
    ...
    /**
     * Gets the 'revinate_analytics.elastica' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Revinate\AnalyticsBundle\Service\ElasticaService A Revinate\AnalyticsBundle\Service\ElasticaService instance.
     */
    protected function getRevinateAnalytics_ElasticaService()
    {
        return $this->services['revinate_analytics.elastica'] = new \Revinate\AnalyticsBundle\Service\ElasticaService($this);
    }

    /**
     * Gets the 'revinate_analytics.routing_loader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Revinate\AnalyticsBundle\Routing\RoutingLoader A Revinate\AnalyticsBundle\Routing\RoutingLoader instance.
     */
    protected function getRevinateAnalytics_RoutingLoaderService()
    {
        return $this->services['revinate_analytics.routing_loader'] = new \Revinate\AnalyticsBundle\Routing\RoutingLoader($this);
    }
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $b->addLoader($this->get('revinate_analytics.routing_loader'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('AnalyticsBundle Test');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'RevinateAnalyticsBundle' => 'Revinate\\AnalyticsBundle\\RevinateAnalyticsBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appTest_localDebugProjectContainer',
            ...
            'kernel.secret' => 'AnalyticsBundle Test',
            ...
            'router.options.matcher.cache_class' => 'appTest_localUrlMatcher',
            'router.options.generator.cache_class' => 'appTest_localUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => ($this->targetDirs[2].'/config/routing.yml'),
            'router.cache_class_prefix' => 'appTest_local',
            ...
            'debug.container.dump' => (__DIR__.'/appTest_localDebugProjectContainer.xml'),
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'revinate_analytics.config' => array(
                'connection' => array(
                    'host' => '127.0.0.1',
                    'port' => 9200,
                ),
