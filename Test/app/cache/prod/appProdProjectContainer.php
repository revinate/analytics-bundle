...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener('', NULL, 85, NULL, true, NULL);
    }
    ...
    {
        return $this->services['http_kernel'] = new \Symfony\Component\HttpKernel\DependencyInjection\ContainerAwareHttpKernel($this->get('event_dispatcher'), $this, new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($this, $this->get('controller_name_converter'), NULL), $this->get('request_stack'), false);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'revinate_analytics.config' => array(
                'sources' => array(
                    'log_event' => array(
                        'class' => 'Revinate\\AnalyticsBundle\\Example\\LogEventAnalytics',
                    ),
                    'guest_stay' => array(
                        'class' => 'Revinate\\AnalyticsBundle\\Example\\GuestStayAnalytics',
                    ),
                    'app_request' => array(
                        'class' => 'Revinate\\AnalyticsBundle\\Example\\AppRequestAnalytics',
                    ),
                ),
            ),
